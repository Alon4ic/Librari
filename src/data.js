export const statuses = [
  { id: 1, color: "#1F2937", background: "#F3F4F6" },
  { id: 2, color: "#991B1B", background: "#FEE2E2" },
  { id: 3, color: "#92400E", background: "#FEF3C7" },
  { id: 4, color: "#065F46", background: "#D1FAE5" },
  { id: 5, color: "#1E40AF", background: "#DBEAFE" },
  { id: 6, color: "#3730A3", background: "#E0E7FF" },
  { id: 7, color: "#5B21B6", background: "#EDE9FE" },
  { id: 8, color: "#9D174D", background: "#FCE7F3" },
];
export const materials = [
  {
    ...
    text: "Your application has been received.  We'll notify you once it's reviewed.",
  },
  {
    id: 2,
    name: "Warning",
...
export const records = [
  {
    icon: `<svg xmlns="http://www.w3.org/2000/svg" width="72" height="52" viewBox="0 0 72 52" fill="none">
