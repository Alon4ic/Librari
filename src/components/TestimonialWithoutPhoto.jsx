...
export default function TestimonialWithoutPhoto({ data, setData }) {
...
<path d="M5 0H8L3 20H0L5 0Z" fill="#2E59F3"/>
      ...
      <div
        style={{
          width: isMobile ? "202px" : "241px",
          height: isMobile ? "135px" : "298px",
          position: "absolute",
          overflow: "hidden",
          display: "flex",
          justifyContent: "center",
      ...
      >
        ...
        <div
          ...
          dangerouslySetInnerHTML={{
            __html: `<svg xmlns="http://www.w3.org/2000/svg" width="8" height="20" viewBox="0 0 8 20" fill="none">
<path d="M5 0H8L3 20H0L5 0Z" fill="#2E59F3"/>
</svg>`,
          }}
        />
